  ...
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <button
        ...
        <svg xlink:href="https://drive.google.com/file/d/1tJZ_MK7b9AFOidJC_8VWYwyJzIyUGwSC/view?usp=drive_link"
          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="mr-2 w-4 h-4">
        <a xlink:href="https://drive.google.com/file/d/1tJZ_MK7b9AFOidJC_8VWYwyJzIyUGwSC/view?usp=drive_link">
        ...
        </svg><a href="https://drive.google.com/file/d/1sRFh6ShUB4RfuPb6ucna1WQ13mXqZNiP/view?usp=drive_link">Download Resume</a></button>
