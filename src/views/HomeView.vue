<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Afif Eka Saputra</h1>
      <div class="py-2">
        <h1
      ...
      <button
        ...
        <svg xlink:href="https://drive.google.com/file/d/1wVdNV5dZ2R3nKazTTlRxTlLVKgXcNp4X/view?usp=sharing"
          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="mr-2 w-4 h-4">
        <a xlink:href="https://drive.google.com/file/d/1wVdNV5dZ2R3nKazTTlRxTlLVKgXcNp4X/view?usp=sharing">
        ...
        </svg><a href="https://drive.google.com/file/d/1wVdNV5dZ2R3nKazTTlRxTlLVKgXcNp4X/view?usp=sharing">Download Resume</a></button>
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://i.postimg.cc/vZ0ffw8j/Yoo.jpg">
    </div>
  </main>
</template>
